    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(64, 64, 64)
                .addComponent(LabelVendedor, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
...
private void RegistrarDetalle() {
    // Iterar sobre las filas de la tabla de ventas
    for (int i = 0; i < TableVenta.getRowCount(); i++) {
        ...
        // Crear un nuevo detalle de venta con los datos obtenidos
        Detalle Dv = new Detalle();
        Dv.setCod_pro(cod);
        Dv.setCantidad(cant);
        Dv.setPrecio(precio);
        Dv.setId(1); // Esto probablemente debería ser dinámico, no está claro en el código
        
        // Registrar el detalle de venta en la base de datos
